...
export function PageFooter() {
  ...
  return (
    <footer className="border-t border-border/70">
      <div className="mx-auto flex min-h-16 w-full max-w-6xl flex-col items-center gap-3 px-4 text-center text-xs bg-muted text-muted-foreground sm:flex-row sm:justify-between sm:text-left">
